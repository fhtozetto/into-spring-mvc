...
import br.com.lph.curso.domain.TipoSexo;
import br.com.lph.curso.domain.Usuario;
...
public class UsuarioDaoImpl implements UsuarioDao{
	...
	private List<Usuario> createUserList() {
	   if (us == null) {
	     ...
	     us.add(new Usuario(System.currentTimeMillis()+2L, "Luiz", "dos Santos", LocalDate.of(1980, 8, 11), TipoSexo.MASCULINO));
